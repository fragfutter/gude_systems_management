...
def parse_args() -> Tuple[Namespace, ConfigParser, ConfigParser, str]:
    ...
    if not _args.upload_ini_found:
        ...
        _args.basedir = os.path.dirname(_args.upload_ini)  # remember location of upload.ini
...
def iterate_list(
    ...
    def _process_device(ip_str_or_obj: Any) -> DeviceResult:
        ...
        try:
            ...
            cfg_filename = DeployDev.get_config_filename(f"{_args.basedir}/config", 'config', 'txt', mac, ip, _args.configip, explicit_filename=explicit_config_file)
            ...
            if skip_ssl:
                ...
                ssl_cert_filename = DeployDev.get_config_filename(f"{_args.basedir}/ssl", 'cert', 'pem', mac, ip, _args.configip, explicit_filename=explicit_ssl_file)
